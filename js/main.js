...
sr.reveal(`.perfil-border`)
sr.reveal(`.perfil-name`, {delay:500})
sr.reveal(`.perfil-profisao`, {delay:600})
sr.reveal(`.profile-infogrupos`, {interval:100, delay:700})
sr.reveal(`.perfil-social`, {delay:700})
